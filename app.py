...
def main():
    ...
    # Apply the styling to the selectbox prompt using markdown
    ...
    # st.write('<span style="color:white">You selected:</span>', year, unsafe_allow_html=True)
    ...
    if st.button('Predict'):
        ...
        input_features = [encoded_location_description, encoded_domestic, encoded_district,encoded_community_area]
        # Make predictions
